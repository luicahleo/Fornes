...
void FLASH_WriteByte(uint32_t flashAddr, uint8_t *flashRdBufPtr, uint8_t byte)
{
    uint32_t blockStartAddr = (uint32_t)(flashAddr & ((0x1fff8 +7) ^ (1024 -1)));
    uint16_t offset = (uint16_t)(flashAddr & (1024 -1));
    uint16_t i;
...
void FLASH_WriteWord(uint32_t flashAddr, uint16_t *flashWrBufPtr, uint16_t word)
{
    ...
    uint16_t offset = (uint16_t)((flashAddr & (1024 -1))/2);
    uint16_t i;
    ...
    for(i=0; i<(1024/2); i++)
    {
        ...
        TBLPTRU = (uint8_t)(((blockStartAddr + WriteWordOffset) & 0x00FF0000) >> 16);
...
int8_t FLASH_WriteBlock(uint32_t writeAddr, uint8_t *flashWrBufPtr)
{
    uint32_t blockStartAddr = (uint32_t )(writeAddr & ((0x1fff8 +7) ^ (1024 -1)));
    uint8_t GIEBitValue = INTCONbits.GIE;
