...
# 250 "./mcc_generated_files/memory.h"
void FLASH_EraseBlock(uint32_t baseAddr);
# 53 "./mcc_generated_files/mcc.h" 2

# 1 "./mcc_generated_files/rtcc.h" 1
# 61 "./mcc_generated_files/rtcc.h"
...
# 98 "./mcc_generated_files/eusart2.h"
void EUSART2_Initialize(void);
# 146 "./mcc_generated_files/eusart2.h"
_Bool EUSART2_is_tx_ready(void);
# 194 "./mcc_generated_files/eusart2.h"
_Bool EUSART2_is_rx_ready(void);
# 241 "./mcc_generated_files/eusart2.h"
_Bool EUSART2_is_tx_done(void);
# 261 "./mcc_generated_files/eusart2.h"
uint8_t EUSART2_Read(void);
# 281 "./mcc_generated_files/eusart2.h"
...
# 69 "main.c"
    ...
    while (1) {
        ...
        printf("\r\nTime:%d", currentTime.tm_hour);
        printf(":%.2d", currentTime.tm_min);
        printf(":%.2d", currentTime.tm_sec);
